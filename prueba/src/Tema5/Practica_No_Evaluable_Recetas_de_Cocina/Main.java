...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            imprimirSelector();
            option = MIEntradaSalida2_0.leerEnteroDeRango("Selección", 1, 9);
            switch (option) {
                ...
                case 2://Buscar Receta
                    try {
                        String receta = MIEntradaSalida2_0.leerCadena("Introduzca el nombre de la receta");
                ...
                case 3://Buscar receta
                    try {
                        Receta receta = r.getRecetaConcreta(MIEntradaSalida2_0.leerCadena("Introduzca el nombre de la receta"));
                        boolean alfab = MIEntradaSalida2_0.leerSN("¿Orden Alfabético? (s/n)") == 'S';
                ...
                case 4://Eliminar Paso
                    try {
                        Receta plato = r.getRecetaConcreta(MIEntradaSalida2_0.leerCadena("Introduzca el nombre de la receta"));
                        ...
                        while (it.hasNext()) {
                            ...
                            if (MIEntradaSalida2_0.leerSN("¿Desea borrar este paso? (s/n)") == 'S') it.remove();
                        }
                    } catch (RestauranteException e) {
                        System.out.println(e.getMessage());
                    }
                ...
                case 6://Comprar ingrediente
                    r.masIngrediente(
                            MIEntradaSalida2_0.leerCadena("Introduzca el nombre del ingrediente"),
                            MIEntradaSalida2_0.leerEnteroPositivo("Introduzca la cantidad comprada")
                    );
                    break;
