package ExamenPokemonRecuperacionHerencia.main;
...
import ExamenPokemonRecuperacionHerencia.exceptions.ValorNoValidoException;
import ExamenPokemonRecuperacionHerencia.interfaces.Atacable;
import ExamenPokemonRecuperacionHerencia.model.Pokemon;
import ExamenPokemonRecuperacionHerencia.utils.UserDataCollector;
   ...
   /* public static void main(String[] args) {
    ...
    private static Atacable seleccionaPokemonAtacable(Pokemon[] pokemons, int i) {
        ...
        for (int j = 0; j < pokemons.length; j++) {
            ...
            if (pokemons[j].estaVivo() && 1 != j && pokemons[j] instanceof Atacable){
